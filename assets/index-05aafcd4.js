import{d as g,i as f,R as u,f as e,E as P,r as k,e as A}from"./ThemeUtil-b7b0243c.js";import{r as y,c as b,n as w}from"./index-3399fbe6.js";import"./index-83d1a4a1.js";import{H as x}from"./HelpersUtil-e9f3a68b.js";import{o as h}from"./if-defined-3b6b684d.js";import"./index-8173741e.js";import"./index-905c64f6.js";const I=g`
  :host {
    display: block;
  }
...
`;var C=globalThis&&globalThis.__decorate||function(t,i,n,r){var o=arguments.length,a=o<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,n):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,n,r);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(a=(o<3?s(a):o>3?s(i,n,a):s(i,n))||a);return o>3&&a&&Object.defineProperty(i,n,a),a};const S=4;let v=class extends f{constructor(){super(...arguments),this.walletImages=[]}render(){const i=this.walletImages.length<S;return e`${this.walletImages.slice(0,S).map(({src:n,walletName:r})=>e`
          <wui-wallet-image
            size="sm"
            imageSrc=${n}
            name=${h(r)}
          ></wui-wallet-image>
        `)}
    ${i?[...Array(S-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};v.styles=[k,O];C([w({type:Array})],v.prototype,"walletImages",void 0);v=C([b("wui-all-wallets-image")],v);const E=g`
  :host {
    width: 100%;
  }
